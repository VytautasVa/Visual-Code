...
async function filter() {
  ...
  if (glass !== "Pasirinkite stiklinės tipą") {
    ...
    filteredArray = filteredArray.filter((drink) =>
      drinksOfGlass.drinks.some((drinkOfGlass) => drink.idDrink === drinkOfGlass.idDrink));
  }
  ...
  if (ingredient !== "Pasirinkite ingridientą") {
    ...
    filteredArray = filteredArray.filter((drink) =>
      drinksOfingredient.drinks.some((drinksOfingredient) => drink.idDrink === drinksOfingredient.idDrink));
  }
  ...
  if (alcoholType === "Alcoholic") {
    ...
    filteredArray = filteredArray.filter((drink) =>
      nonAlcoholicDrinks.drinks.some((nonAlcoholicDrink) => drink.idDrink === nonAlcoholicDrink.idDrink));
  }
...
function closeModal(event) {
  if(event.target === modal || modal.contains(event.target) || event.target.classList.contains("modal-close-button")){
